...
while True:
    ...
    if s == "qwerty" or ((u0 or u1 or u2) and not (u3 or u4)):
        ...
        snumber = input()
        print("Enter your MRCET id : ")
        sid = input()
        print("Enter your score :" )
        sscore = int(input())
        print( "Preferred branch : " )
        print(" Enter 0 for MRCET-B.E. Chemical ")
        print(" Enter 1 for MRCET-B.E. Civil ")
        print(" Enter 2 for MRCET-B.E. Electrical & Electronics ")
        print(" Enter 3 for MRCET-B.E. Mechanical ")
        print(" Enter 4 for MRCET-B.E. Manufacturing ")
        print(" Enter 5 for MRCET-B.Pharm. ")
        print(" Enter 6 for MRCET-B.E. Computer Science ")
        print(" Enter 7 for MRCET-B.E. Electronics & Instrumentation ")
        print(" Enter 8 for MRCET-M.Sc. Biological Sciences ")
        print(" Enter 9 for MRCET-M.Sc. Chemistry ")
        print(" Enter 10 for MRCET-M.Sc. Economics ")
        print(" Enter 11 for MRCET-M.Sc. Mathematics ")
        print(" Enter 12 for MRCET-M.Sc. Physics ")
        sbranch = int(input())
